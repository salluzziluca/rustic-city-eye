...
pub struct Drone {
    ...
    send_to_client_channel: Arc<Mutex<Option<Sender<Box<dyn MessagesConfig + Send>>>>>,
...
impl Drone {
    ...
    pub fn new(
        ...
        let connect_config =
            Drone::read_connect_config("./drones/packets_config/connect_config.json", id)?;
...
//         let file_path = "./src/packets_config/connect_config.json";
//         let id = 1;
...
//                 location,
//                 center_location,
//                 "./src/packets_config/drone_config.json",
